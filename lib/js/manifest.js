...
var DEBUG = true,
	...
	OPTIONS = {
        ...
        HELP : {
            ...
            ,"BitBucketHelp": "<dl><dt>For BitBucket latest api use</dt><dd>/rest/api/latest/inbox/pull-requests</dd><dt>For legacy stash use</dt><dd>/rest/inbox/latest/pull-requests</dd></dl>followed by ?...your options..."
        }
