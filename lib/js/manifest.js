...
var DEBUG = true,
	...
	OPTIONS = {
        ...
        HELP : {
            ...
            ,"BitBucketHelp": "<dl><dt>For BitBucket Server latest API use</dt><dd>/rest/api/latest/inbox/pull-requests?... your options ...</dd><dt>For legacy STASH use</dt><dd>/rest/inbox/latest/pull-requests?... your options ...</dd><dt>For BitBucket Cloud use</dt><dd>/repositories/{account}/{repo}/pullrequests?q=state=\"OPEN AND\"+... your options ...<br/>See <a href=https://developer.atlassian.com/bitbucket/api/2/reference/meta/filtering#query-pullreq target=_blank>API reference</a> and <a href=https://docs.atlassian.com/bitbucket-server/rest/6.3.2/bitbucket-rest.html#idp82  target=_blank>bitbucket rest</a></dd></dl>"
