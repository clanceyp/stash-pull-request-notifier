(function($, can, chrome, window){
	...
	var backgroundPage = chrome.extension.getBackgroundPage(),
        popup = {
			...
			showAuthored: backgroundPage.kmj.getLocalStore("AuthorTabEnabled"),
            messages:{
            ...
            init:function() {
                ...
                $("body")
	                ...
	                .addClass('is-author-visible-'+ popup.showAuthored)
            ...
            render:function(){
                ...
                if (popup.items.length > 0 || popup.authorItems.length > 0) {
