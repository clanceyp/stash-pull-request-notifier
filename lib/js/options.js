    ...
    options = {
        ops:{
            "input":[
                ...
                {"name":"PopupTemplate","label":"Mustache template","type":"textarea",  parent:'advanced', className:""},
                ...
                {"name":"StashCSS","label":"Pull request CSS","type":"textarea",  parent:'advancedStash', className:""},
                {"name":"StashJS","label":"Pull request JS","type":"textarea",  parent:'advancedStash', className:""}
            ]
        },
        init:function(){
