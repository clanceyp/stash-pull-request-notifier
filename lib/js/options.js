...
var backgroundPage = chrome.extension.getBackgroundPage(),
    ...
    options = {
        ops:{
            "input":[
                {"name":"JiraURL","label":"Stash URL","type":"text"},
                {"name":"JiraAPI","label":"Stash rest","type":"text", className:"allowDblClickReset"},
                ...
                {"name":"RefreshTime","label":"Refresh time","type":"text", className:"allowDblClickReset","html5":"range",  parent:'default',ops:{"min":5,"max":600,"step":5,"range-type":"s"}},
