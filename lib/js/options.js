    ...
    options = {
        ops:{
            "input":[
                ...
                {"name":"API","label":"Repo. JSON url","type":"text", className:"allowDblClickReset",  parent:'advanced'},
                {"name":"AuthorAPI","label":"Author JSON url","type":"text", className:"allowDblClickReset",  parent:'advanced'},
                {"name":"BitBucketHelp","type":"title","tag":"div", parent:'advanced', "label":"", "className": "indent"},
                ...
                {"name":"StashCSS","label":"Pull request CSS","type":"textarea",  parent:'advancedStash', className:"allowDblClickReset"},
                {"name":"StashJS","label":"Pull request JS","type":"textarea",  parent:'advancedStash', className:"allowDblClickReset"}
            ]
        },
        init:function(){
...
$(document).ready(function(){
    ...
    $('.json-viewer').on('click',function(e){
        ...
        if (backgroundPage.kmj.items && backgroundPage.kmj.items.length){
            ...
            alert("Sorry, no items found, are you logged in?");
        }
    });
