...
(function($, _, can, chrome, document, window){
    ...
    chrome.browserAction.onClicked.addListener(function(tab) {
        ...
        chrome.tabs.executeScript(null, {file: "lib/js/vendor/zepto.js", runAt: "document_end"});
        chrome.tabs.executeScript(null, {file: "lib/js/content_script.js", runAt: "document_end"});
    });
    */
