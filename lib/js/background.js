...
* /repositories/clanceyp/test-private-01/pullrequests?state="OPEN%20AND%20role=author&limit=20"
*
* */
...
(function($, _, can, chrome, document, window){
    ...
    var console = window.console,
        ...
        kmj = {
            ...
            seenNotifications: [],
            opendNotifications: [],
            snoozedItems:  JSON.parse(options.getLocalStore('snoozedItems', '[]')),
            ...
            addSnoozed: function(id, remove){
                ...
                options.setLocalStore('snoozedItems', JSON.stringify(kmj.snoozedItems));
                kmj.init();
            },
