    ...
    var DEFAULT_VALUES = window.DEFAULT_VALUES,
        ...
        kmj = {
            ...
            handleResponse:function(data){
                ...
                kmj.items = _.sortBy(kmj.json.values,function(item){ return - item.createdDate });
                kmj.items.forEach(function(item){
                ...
                kmj.updateBrowserActionStatus( kmj.json.size, unapproved );
